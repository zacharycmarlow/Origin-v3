...
const CHAPTERS: Chapter[] = [
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        lore: {
          title: "The monomyth",
          body: "Joseph Campbell found the same skeleton underneath every myth on earth: a character living in the ordinary world receives a call, crosses a threshold into the unknown, descends into territory that breaks them apart, and returns transformed, carrying something the community needs. Separation, initiation, return. Not because the cultures copied each other, because they were all mapping the same territory: the actual shape of human transformation. You are living it now. The seven chapters ahead follow the arc that every hero has always walked."
        },
      ...
      },
      {
        ...
        lore: {
          ...
          body: "For three hundred thousand years before writing existed, human beings passed their lives through story spoken aloud. The griot in West Africa, the bard in the Celtic world, the elder at the Aboriginal fire — the storyteller was sacred in every culture that lasted long enough to need one. Story was the technology of identity, continuity, meaning. You are doing the oldest thing there is."
        },
    ...
    scenes: [
      ...
      },
      {
        ...
        code: {
          ...
          body: "Stephen Porges showed that the autonomic nervous system is literally entrained by the nervous systems of early caregivers. Your threat responses, your relational patterns, your default ways of reading a room run code written by whoever was in the room when you were learning what the world was. The nervous system is shaped by attunement before language, before conscious memory. Understanding this is the beginning of authorship."
        },
        ...
        lore: {
          title: "Karma",
          body: "The Sanskrit word karma means action, and its deepest teaching is that unconscious action generates binding consequence, the wheel turns because the pattern is the only program loaded. Arjuna stands paralyzed on the battlefield in the Bhagavad Gita, unable to act because acting means confronting everything his conditioning has made him. Krishna's teaching comes down to one recognition: as long as you identify with the actor, the cycle owns you. The Norse called the binding pattern wyrd. The Buddhists called the wheel samsara. Every tradition recognized: while the loop runs, choice is not available. Seeing the loop is the first act of freedom."
        },
      ...
      },
      {
        ...
        code: {
          ...
          body: "The moment you hold the character's wound with genuine compassion, the actual felt sense of love for someone who did the best they could with what they were given, the identification loosens. The author emerges from behind the character."
        },
        ...
        lore: {
          ...
          body: "Every shamanic tradition on earth understood that the healer's power comes from their wound. The shaman's initiatory crisis is always a confrontation with what breaks you, the experience of being taken apart so completely that ordinary life becomes impossible, and from that breaking, something emerges that the community needs. Your intimate knowledge of the tension becomes your qualification. The wound is the credential."
        },
    ...
    scenes: [
      ...
      },
      {
        ...
        code: {
          ...
          body: "Sustained slow breathing measurably decreases cortisol, increases heart rate variability, and shifts the nervous system from threat-detection into the open, receptive state associated with creativity, connection, and meaning-making. Gratitude requires an open body. The breath creates the conditions for the turn."
        },
        ...
        lore: {
          ...
          body: "Pranayama built an entire science around the breath as the technology of transformation. The hesychast prayer of the Christian mystics, the ceremonial breathing of indigenous peoples across every continent, the long exhale of Buddhist meditation — the breath has been understood as the threshold between what happens to you and what you do with it for as long as humans have had a contemplative life. It is the first act of authorship over the physical self."
        },
      ...
      },
      {
        ...
        lore: {
          ...
          body: "Rumi spent his life writing about one thing: the wound is the place where the light enters. Permaculture says the problem is the solution, the energy trapped in the dysfunction is exactly the energy needed to resolve it. Nietzsche's eternal recurrence poses the ultimate test: could you choose this life again, every wound included? The capacity to say yes, because of what the wounds produced, is the alchemy. Frankl called it the last human freedom: the freedom to choose the meaning of what cannot be changed."
        },
    ...
    scenes: [
      {
        ...
        lore: {
          ...
          body: "The Haudenosaunee Confederacy holds every decision accountable to seven generations back and seven generations forward, because they understand that every present moment exists inside a web extending in both directions through time. The African philosophy of Ubuntu, I am because we are, expresses the same recognition. The Aboriginal Songlines as the paths that made you, the Celtic memory of lineage, the Chinese veneration of ancestors — every tradition that lasted understood: you are what made you, and what made you is worth knowing."
        },
      ...
      },
      {
        ...
        lore: {
          ...
          body: "The yogis built an entire science of the body as vehicle for the divine — asana, pranayama, mudra, all designed to refine the instrument. The sun dancers of the Lakota offer the body as proof of dedication. The Jews keep kosher and observe Shabbat, the body reminded at every meal, every rest of what it belongs to. The Aboriginal practitioners walk the Songlines, the walking itself as prayer. Every tradition that lasted understood: the body is the proof of what you actually hold sacred."
        },
      ...
      },
      {
        ...
        code: {
          ...
          body: "The same story held at different scales reveals different structure. From inside the character's life, the events can feel random, sometimes senseless. From the perspective of the source, the arc becomes legible. The wound was preparation. The gift was the wound transformed. The conditions were the specific training ground for the specific work this life was meant to do."
        },
        ...
        lore: {
          ...
          body: "Every creation myth is the source telling the story of what it made and why. The Kogi creation story begins in the thought of the Mother of Origin. The Lakota stories place the human at the center of a web of relations. The Book of Genesis opens in the mind of God before the world. In every case, the source has a story it is telling through the lives it produces. This character is one of those lives."
        },
    ...
    scenes: [
      {
        ...
        code: {
          ...
          body: "Neuroscience calls it the default mode network, the most energy-intensive system in the brain, running every moment you are not absorbed in something external. Georg Northoff's research on self-referential processing shows that this network generates the sense of self from moment to moment, stitching memory, anticipation, and evaluation into a continuous character. It produces the default version of you, the one who shows up when you are not actively choosing, the one you fall back into whenever your energy drops. This is the primary process, running underneath everything you do."
        },
        ...
        lore: {
          title: "The daimon",
          body: "Every culture in human history described a voice, a companion spirit, a guiding force, a narrator of the self. The Greeks called it the daimon, the spirit that accompanies each soul through life, carrying the pattern of its purpose. Christianity collapsed it into the demon, stripping its complexity. The original understanding was closer to the truth: the voice is real, it lives in the architecture of the brain, it was built to protect you in a chaotic world, and it is still running code written for conditions that no longer exist. A fallen guide. Ignorant rather than malevolent. Defaulting to itself in the absence of an author."
        },
      ...
      },
      {
        ...
        code: {
          ...
          body: "Marcus Raichle's research, which first described the DMN, shows that this network constructs the experienced world from top-down prediction, filling in experience based on existing narrative before the senses even report. The brain does not receive reality. It predicts it, based on the story it has been running, and confirms the prediction. This is why insight alone does not change behavior: the narrative system generates the conditions of experience before conscious choice can intervene."
        },
        ...
        lore: {
          title: "The veil",
          body: "The Hindus called it Maya, the narrative so total that questioning it feels absurd. Plato placed humanity in a cave, chained so they could only see shadows projected on the wall, mistaking them for the world. The Gnostics described archons, rulers of a constructed reality so woven into experience that the imprisoned never recognize the prison. The Buddhists described samsara, the wheel turning because the beings on it cannot see the wheel. The Sufis named the commanding self. Every tradition that examined consciousness closely found the same structure, in the languages available to them. You are seeing through it now."
        },
      ...
      },
      {
        ...
        lore: {
          ...
          body: "Shamanic traditions across every continent understood that the body is a community of characters, each carrying a piece of the story. Internal Family Systems therapy maps the same terrain through psychology: sub-personalities, protectors, exiles, each holding a frozen moment from the past, each responding to the author's attention. The throat that was taught silence. The chest that learned to armor. The belly that contracted around danger. The body is where the old narrative was written. It is also where the new one is installed."
        },
    ...
    scenes: [
      ...
      },
      {
        ...
        code: {
          ...
          body: "The default mode network builds reality from imagination, simulating futures, constructing possible selves, rehearsing scenarios the body responds to as real. Imagination pointed at catastrophe produces the chemistry of catastrophe. Pointed at a vivid future, it produces the chemistry of that future.\n\nAnd here is what the modern world has almost successfully taught us to forget: when we suppress our dreams, they do not disappear. They rule us in secret, the undertow beneath our decisions, the unnamed ache behind our busyness, the restlessness we medicate and distract and scroll past at two in the morning."
        },
        lore: {
          title: "The vision quest",
          body: "The Lakota hanblecheyapi strips away comfort and certainty because your deepest nature can only be seen when everything else has been removed and what remains is what you actually are. The Sufi khalwa, the Celtic pilgrimage, the Aboriginal walkabout, every culture developed a practice of going to the threshold to receive a vision of who you are meant to become. The vision received was not a fantasy. It was an instruction. The community held you accountable to it."
        },
      ...
      },
      {
        ...
        code: {
          ...
          body: "The motor cortex fires during mental rehearsal at nearly the intensity of physical practice. Studies show that people who only imagine performing strength training develop measurable physical adaptations. Method acting works because the nervous system treats the character as real when fully inhabited. You become who you practice being."
        },
      ...
      },
      {
        ...
        code: {
          ...
          body: "Sustained emotional states alter gene expression. The nervous system, gut microbiome, and cellular repair mechanisms all optimize for the future the organism most vividly believes is coming. What you rehearse with conviction, the body begins to build toward. The biology follows the belief."
        },
    ...
    scenes: [
      ...
      },
      {
        ...
        lore: {
          ...
          body: "Every initiation tradition ends with the return, the moment the transformed person re-enters the community carrying what they found in the descent. The community that receives the returning hero is changed by what they bring back. This is the purpose of the journey, the bringing back of something the community needs. What you carry back from this is not just for you."
        },
